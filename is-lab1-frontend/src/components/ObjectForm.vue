      ...
      <div class="form-grid">
        ...
        <div class="form-field">
          ...
          <select v-model="form.genre" class="input">
            <option v-for="g in enums.genres" :key="g" :value="g">
              {{ g }}
            </option>
          </select>
        </div>
        ...
        <div class="form-field">
          ...
          <input
            v-model.number="form.totalBoxOffice"
            class="input"
            type="number"
          />
        </div>
        ...
        <div class="form-field">
          ...
          <input
            v-model.number="form.usaBoxOffice"
            class="input"
            type="number"
          />
        </div>
        ...
        <div class="form-field">
          ...
          <input
            v-model.number="form.goldenPalmCount"
            class="input"
            type="number"
          />
          <div v-if="errors.goldenPalmCount" class="error">
            {{ errors.goldenPalmCount }}
          </div>
        </div>
        ...
        <div class="form-field">
          ...
          <input
            v-model.number="form.oscarsCount"
            class="input"
            type="number"
          />
        </div>
        ...
        <div class="form-field" style="grid-column: 1/3">
          ...
          <div v-if="errors.coordinatesId" class="error">
        ...
        <div class="form-field">
          ...
          <select v-model="ids.directorId" class="input">
            <option v-for="p in personsOptions" :key="p.value" :value="p.value">
              {{ p.label }}
            </option>
          </select>
          <div v-if="errors.directorId" class="error">
            {{ errors.directorId }}
          </div>
        </div>
        ...
        <div class="form-field">
          ...
          <div v-if="errors.operatorId" class="error">
            {{ errors.operatorId }}
          </div>
        </div>
      </div>
  ...
  setup(props, { emit }) {
    ...
    (async () => {
      try {
        ...
        coordinatesOptions.value = coordsItems.map((c) => ({
          value: c.id,
          label: `${c.id}: (${c.x}, ${c.y})`,
        }));
      } catch (e) {
      ...
      try {
        ...
        const personItems = Array.isArray(persons)
          ? persons
          : persons.items || [];
        personsOptions.value = personItems.map((p) => ({
          value: p.id,
    ...
    const validate = () => {
      ...
      if (!ids.value.coordinatesId)
        errors.value.coordinatesId = "Select coordinates";
      ...
      try {
        if (props.mode === "create") {
          await createObject({
            ...
            screenwriter: ids.value.screenwriterId
              ? { id: ids.value.screenwriterId }
              : null,
